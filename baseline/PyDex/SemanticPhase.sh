...
k=5
RetrievalDir="PyDex"
INPUTFILE="baseline/PyDex/RetrievalPyDex.json"
GENDIR="baseline/results/StageToStage/$RetrievalDir/top$k/$MODEL"
GENFILE="PyDexTop${k}Res.json"

python -m baseline.PyDex.SemanticPhase \
...
ExecutionPath="baseline/results/StageToStage/$RetrievalDir/EVAL/top$k/${MODEL}/Execution"
...
NUM_THREADS=10
FinalOutDir="baseline/results/StageToStage/$RetrievalDir/EVAL/top$k/${MODEL}/EvaluateDesc"
