...
class RepairManager:
    ...
    def _process_submission(self, submission_id: str) -> dict:
        ...
        all_references = [entry['RetrievalCode'] for entry in top_k_results]
        ...
        prompt = (
            ...
            .replace("<REFERENCES>", reference_code)
        )
        if not prompt:
...
Some reference correct code will be provided to you, please refer to them selectively.
[Programming Problem]: <TASK_DESCRIPTION>
[Reference correct code]: <REFERENCES>
