...
class RepairManager:
    ...
    def _process_submission(self, submission_id: str) -> dict:
        ...
        return {
            ...
            "bug_locations": info["bug_locations"],
            "full_bugloc_content": info["full_bugloc_content"],
        }
...
You will be provided with a file containing bug location markers; any line starting with “-” denotes a buggy line.
[Bug Location]: <BUG_LOCATIONS>
