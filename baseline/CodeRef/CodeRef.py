...
class RepairManager:
    def __init__(self, prompt_template: str, language: str, test_dataset_file: str, problem_description_file: str, retrieval_data_file: str, to_dir: str, save_file_name: str, num_thread: int = 10, model="gpt-4o-ca", topk=5) -> None:
    ...
    def _process_submission(self, submission_id: str) -> dict:
        ...
        all_references = [(
            self.retrieval_data_dict[entry['RetrievalSubmission1_id']]["code1"], 
            self.retrieval_data_dict[entry['RetrievalSubmission1_id']]["code2"]
...
""", help="prompt template")
    ...
    parser.add_argument('--retrieval_data_file', type=str, default='./dataset/Filtered_pair/code1_Added_testScode_pairs/Exec_test_processed_pair.json')
    ...
    RepairManager(prompt_template=args.prompt_template, 
                  ...
                  topk=args.topk,
                  retrieval_data_file=args.retrieval_data_file).start()
