...
RetrievalModel="CommentDiff_Refine"
RetrievalDir="Qwen3-Embedding-0.6BData"

INPUTFILE="data/ALL/${RetrievalDir}/desc/desc_${mode}.json"
GENDIR="baseline/results/StageToStage/${RetrievalModel}/top${k}/${MODEL}/Init"
...
ExecutionPath="baseline/results/StageToStage/${RetrievalModel}/EVAL/top${k}/${MODEL}/Init/Execution"
...
InitOutDir="baseline/results/StageToStage/${RetrievalModel}/EVAL/top${k}/${MODEL}/Init/EvaluateDesc"
...
for ITER in $(seq 1 ${NUM_REFINE}); do
  ...
  # 1. 筛选出未通过的样本
  REFINEDIR="baseline/results/StageToStage/${RetrievalModel}/top${k}/${MODEL}/Refine${ITER}"
  mkdir -p "${REFINEDIR}"
  ...
  CUDA_VISIBLE_DEVICES=0,1 python -m VectorRetrieval.VectorRetrievalSecondStage \
  ...
  ExecPath="baseline/results/StageToStage/${RetrievalModel}/EVAL/top${k}/${MODEL}/Refine${ITER}/Execution"
  ...
  FinalOutDir="baseline/results/StageToStage/${RetrievalModel}/EVAL/top${k}/${MODEL}/Refine${ITER}/EvaluateDesc"
...
#     --json_file "./baseline/results/StageToStage/${RetrievalModel}/EVAL/top${k}/${MODEL}/Refine${NUM_REFINE}/EvaluateDesc/Refine_${GENFILE}"
