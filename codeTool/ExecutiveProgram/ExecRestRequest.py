...
class APIManager:
    ...
    def Modify_Command_For_Compile_Program(self, new_args, code_content, language = "Python"):
        ...
        if language == "Python":
            ...
            # print(Execute_File_name_without_type) # s001
...
if __name__ == '__main__':
    ...
    if TEST_EXCUTE_FILE == True:
        ...
        CopyIn_fileId = "YZTXUOS6"
        Execute_File_name = "__pycache__/s444443884.cpython-311.pyc"
        # TestPoint_Content = "1\n0.0 0.0 2.0 0.5127281311709682 2.0 2.0"
        TestPoint_Content = "xyz\nabc\n"
